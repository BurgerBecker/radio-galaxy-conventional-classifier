...
% In theory, CNN's are meant to be at least partially rotation and translation invariant.
...
% In the case of radio astronomy, this would be the Fanaroff-Riley morphological 
% classification scheme \cite{fanaroff_riley_1974}. 

% Extra-galactic radio sources were originally divided into two classes, namely Fanaroff-Riley (FR) type I and type II. These sources are described as being edge brightened and lobe brightened, respectively. Originally, they were described by Fanaroff and Riley in their seminal paper on extra-galactic source classification based on morphological features \cite{fanaroff_riley_1974}. The classification scheme is based on the ratio of the distance between the hotspots and the total length of the object, with all sources greater than 0.5 being classified as FRII and all less as FRI. This can be seen as illustrated by figure with A being the distance between hotspots and B the total length of the source up to the furthest contour edges. 





% The main problem with the FR dichotomy is the
% morphological feature space used during classification. Even though one of the 
% official features in the literature seems to be the FR ratio, very few astronomers 
% and astrophysicist use this as the main morphological feature.\footnote{Vaccari, M, Inter-University Institute for Data Intensive Astronomy, and Department of Physics and Astronomy, University of the Western Cape
% , Private Bag X17, Bellville 7535, South Africa, Private Communication}
